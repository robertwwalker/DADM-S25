...
subtitle: "Lecture 2: AI and Argumentation with Data"
...
- Catch up first day work
- Get the cloud setup going
- Toulmin and Argumentation with Data
- On Artificial Intelligence

## Administrative Things

- The Last Day is set for December 2
- A slight syllabus reorganization
- The Group Task: Global Strategic Trends

# A Bit of First Day Work

## Some Example Data

The data are Bond.Funds.  We have an ID, Type, Assets, Fees [Yes or No], Expense Ratio, Returns in 2009, 3 year, 5 year, and a Risk classification.  A [link to the data in Excel format NB auto-downloads.](https://github.com/robertwwalker/DADMStuff/raw/master/BondFunds.xlsx). [link to the data in csv format NB auto-downloads.](https://github.com/robertwwalker/DADMStuff/raw/master/BondFunds.csv).
...
## Installing Radiant and posit.cloud

1. Login to [posit.cloud](http://posit.cloud/)
2. At the command prompt, `install.packages("radiant")`
3. `radiant::radiant()`

## `radiant` a tour

Let's grab that .csv file

`https://github.com/robertwwalker/DADMStuff/raw/master/BondFunds.csv`
...
`https://posit.cloud/content/10806641`
...
- Familiarity/empathy
- We are using the mental model people most use to make persuasive statements.
