...
format: 
   revealjs:
     ...
     scrollable: true
     logo: AGSMlogo.jpeg
     footer: "DADM: Week 1 (26 Aug 2025)"
     chalkboard: true
...
1. Read Toulmin and examine the slide excerpt.
2. Prepare to discuss: what is a large language model?
3. Are LLM's authoritative sources?  What managerial challenges does this present?
